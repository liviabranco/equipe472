...
public class User implements Serializable {
    ...
    * @generated
    */
    @Column(name = "safeadress", nullable = true, unique = false, insertable=true, updatable=true)
        
        private java.lang.String safeadress;

    /**
    * @generated
    */
    @ManyToOne
    @JoinColumn(name="fk_contacts", nullable = true, referencedColumnName = "id_user", insertable=true, updatable=true, foreignKey = @ForeignKey(name = ""))
    ...
    */
    ...
    public java.lang.String getSafeadress(){
        return this.safeadress;
    }

    /**
    * Define safeadress
    * @param safeadress safeadress
    * @generated
    */
    public User setSafeadress(java.lang.String safeadress){
        this.safeadress = safeadress;
        return this;
    }
    /**
    * Obtém contacts
